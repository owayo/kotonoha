...
FEATURE_DIM = 19  # v60: 14 -> 19 (v38 14 dim + 5 soft teacher stats from v24 logits)
# Layout:
...
class _AccentDataset(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        FEATURE_DIM=19 の最後 6 dim (argmax/20 + 5 soft stats) を埋める。
        渡さない場合は teacher_preds (argmax 系列) のみで argmax/20 のみ
        埋め、soft stats は 0 になる (v38 互換)。
        """
        ...
        for utt, tpred, tlog in zip(utterances, tpreds, tlogits, strict=True):
            ...
            for i, m in enumerate(morphemes):
                ...
                feat = [*feat_13, tp_argmax, *soft_extra]
...
def main() -> None:
    ...
    print("=" * 65)
    print(
        "kotonoha accent model trainer v60 "
        "(19-dim = 14-dim v38 + 5 soft teacher stats from v24 logits)"
    )
