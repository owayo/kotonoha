...
with open(
    "/home/owayo/kotonoha-training/data/jsut_accent_data_v3.json", encoding="utf-8"
) as f:
...
sess_v48 = ort.InferenceSession(
    "/mnt/c/GitHub/kotonoha-models/accent_model_v48.onnx", providers=providers
)
...
for utt in val_utts:
    ...
    f14 = np.concatenate(
        [f13[:, :13], (v24_arg.astype(np.float32) / 20.0).reshape(-1, 1)], axis=1
    )
...
print(
    f"v20+v17+v48: {acc_combo([(0.33, s_v20), (0.33, s_v17), (0.33, s_v48)]) * 100:.2f}%"
)
print(
    f"v20+v17_tta+v48: {acc_combo([(0.4, s_v20), (0.3, s_v17), (0.3, s_v48)]) * 100:.2f}%"
)
