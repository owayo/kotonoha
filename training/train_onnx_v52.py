...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Train kotonoha accent model v52")
    parser.add_argument(
        "--pretrain-data",
        type=Path,
    ...
    parser.add_argument(
        "--state-dir",
        type=str,
        default="/tmp/v52_states",
        help="v52: per-seed state save directory",
    )
    parser.add_argument(
        "--resume",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="v52: KD disabled by default (ensemble teacher uses argmax feature only)",
    )
    parser.add_argument(
        "--kd-temperature",
        type=float,
    ...
    print("=" * 65)
    print("kotonoha accent model trainer v52 (14-dim + ENSEMBLE teacher argmax)")
