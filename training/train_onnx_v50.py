...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Train kotonoha accent model v50")
    parser.add_argument(
        "--pretrain-data",
        type=Path,
    ...
    parser.add_argument(
        "--teacher-cache",
        type=str,
        default="/tmp/v50_teacher_v24_logits.pt",
    ...
    parser.add_argument(
        "--bert-cache-jvs",
        type=str,
        default="/tmp/bert_emb_jvs.pt",
    )
    parser.add_argument(
        "--bert-cache-jsut",
        type=str,
        default="/tmp/bert_emb_jsut.pt",
    )
    parser.add_argument(
        "--bert-cache-corpus",
        type=str,
        default="/tmp/bert_emb_corpus.pt",
    )
    parser.add_argument(
        "--bert-cache-filtered-jvs",
        type=str,
        default="/tmp/bert_emb_filtered_jvs.pt",
    )
    ...
    print("=" * 65)
    print("kotonoha accent model trainer v50 (14-dim + 768-dim BERT embedding)")
